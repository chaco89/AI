...
latest_model = "nestedlstm-weights.49-0.999-0.003.hdf5"
...
new_model = load_model(latest_model, custom_objects={'NestedLSTM': NestedLSTM})
...
# save model
new_model.save("final_nested_lstm_model.hd5")